...
public class MothManStore extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moth_man_store);

        //setting title bar name
        getSupportActionBar().setTitle("Moth Man Store");
        ...
        //setting sizeSpinner and sizeTextView to not be visible
        ...
        goToCart.setOnClickListener(v -> {
            startActivity(new Intent(MothManStore.this, Cart.class));
        });
        ...
        addToCart.setOnClickListener(v -> {
            ...
            if (!loggedIn){
                ...
                startActivity(new Intent(MothManStore.this, LoginPage.class));
            }
            else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.item1) {
            ...
            if (isLoggedIn) {
                ...
                Toast toast = Toast.makeText(MothManStore.this, "Logged Out Successfully", Toast.LENGTH_LONG);
                toast.show();
                editor.commit();
                ...
                Toast toast = Toast.makeText(MothManStore.this, "You aren't logged in currently", Toast.LENGTH_LONG);
                toast.show();
            }
            return true;
        }
            ...
            startActivity(new Intent(MothManStore.this, CryptidStorePage.class));
            return true;
        } else if (id == R.id.item4) {
            startActivity(new Intent(MothManStore.this, MainActivity.class));
            return true;
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        String choice = parent.getItemAtPosition(position).toString();
            ...
            switch (choice){
                case "T-shirt":
                    itemDesc.setText("Moth man over the Silver Bridge T-shirt");
                    itemPic.setImageResource(R.drawable.mothmanshirt);
                    sizeSpinner.setVisibility(View.VISIBLE);
                    sizeTextView.setVisibility(View.VISIBLE);
                    break;

                case "Coffee Mug":
                    itemDesc.setText("Point Pleasant WV Moth Man Mug");
                    itemPic.setImageResource(R.drawable.mothmanmug);
                    sizeSpinner.setVisibility(View.INVISIBLE);
                    sizeTextView.setVisibility(View.INVISIBLE);
                    break;

                case "Baseball Cap":
                    itemDesc.setText("Moth Man Cap");
                    itemPic.setImageResource(R.drawable.mothmanhat);
                    sizeSpinner.setVisibility(View.INVISIBLE);
                    sizeTextView.setVisibility(View.INVISIBLE);
                    break;
        }

...
public class LochNessStore extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loch_ness_store);

        //setting title bar name
        getSupportActionBar().setTitle("Loch Ness Monster Store");
        ...
        goToCart.setOnClickListener(v -> {
            startActivity(new Intent(LochNessStore.this, Cart.class));
        });
        ...
        addToCart.setOnClickListener(v -> {
            ...
            if (!loggedIn){
                ...
                startActivity(new Intent(LochNessStore.this, LoginPage.class));
            }
            else {
                ...
                switch (itemChoice) {
                    case "T-shirt":
                        ...
                        addedToCart = databaseHelper.insertCartData(101, price, sizeChoice, customerID, quantity, desc);
                    ...
                    case "Coffee Mug":
                        ...
                        addedToCart = databaseHelper.insertCartData(102, price, null, customerID, quantity, desc);
                    ...
                    case "Baseball Cap":
                        ...
                        price = 18.00;
                        desc = "Nessie Cap";
                        addedToCart = databaseHelper.insertCartData(103, price, null, customerID, quantity, desc);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.item1) {
            ...
            if (isLoggedIn) {
                ...
                Toast toast = Toast.makeText(LochNessStore.this, "Logged Out Successfully", Toast.LENGTH_LONG);
                toast.show();
                editor.commit();
                ...
                Toast toast = Toast.makeText(LochNessStore.this, "You aren't logged in currently", Toast.LENGTH_LONG);
                toast.show();
            }
            return true;
        }
            ...
            startActivity(new Intent(LochNessStore.this, CryptidStorePage.class));
            return true;
        } else if (id == R.id.item4) {
            startActivity(new Intent(LochNessStore.this, MainActivity.class));
            return true;
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        String choice = parent.getItemAtPosition(position).toString();
            ...
            switch (choice){
                case "T-shirt":
                    itemDesc.setText("Hide and Seek World Champion Nessie Shirt");
                    itemPic.setImageResource(R.drawable.nessieshirt);
                    sizeSpinner.setVisibility(View.VISIBLE);
                    sizeTextView.setVisibility(View.VISIBLE);
                    break;

                case "Coffee Mug":
                    itemDesc.setText("Cartoon Nessie Mug");
                    itemPic.setImageResource(R.drawable.nessiemug);
                    sizeSpinner.setVisibility(View.INVISIBLE);
                    sizeTextView.setVisibility(View.INVISIBLE);
                    break;

                case "Baseball Cap":
                    itemDesc.setText("NASA Nessie Cap");
                    itemPic.setImageResource(R.drawable.nessiehat);
                    sizeSpinner.setVisibility(View.INVISIBLE);
                    sizeTextView.setVisibility(View.INVISIBLE);
                    break;
        }
